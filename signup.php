        ...
        <div class="col-6">
            <div class="card">
                ...
                <div class="input-group mb-3">
                        ...
                        <input type="text" name="fullname" class="form-control" placeholder="Full Name" aria-label="email" aria-describedby="basic-addon1">
                    </div>
                     <div class="input-group mb-3">
                    ...
                    <hr/>
                      Do not have account? <a href="login.php">Log In</a>
